// deno-lint-ignore-file no-var no-inner-declarations no-window no-prototype-builtins no-unused-vars
const kofiWidgetOverlayConfig = {
  ...
  "floating-chat.donatebutton.image":
    "/files/img/buttons/ko-fi-transparent.png",
  ...
  function (config, _utils) {
    ...
    var getHtml = function () {
      ...
      var body =
        ...
        `<img id="${getButtonId()}" src="${donateButtonImage}" class="hiddenUntilReady closed" style="z-index:10000;display: flex !important; image-rendering: pixelated; height: 46px;"></img>`;
      return body;
    };
